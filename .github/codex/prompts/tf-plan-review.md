...
4. Check the Terraform code and plan for violations of the Team Dos and Don'ts. Report each finding with the breached rule and where it appears (file/resource). Call out compliance when things look good.
